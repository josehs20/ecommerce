...
@section('conteudo')
    ...
    <div id="app">
        ...
        <div class="detalhes">
            ...
            <div class="abrirmodal" style="padding: 25px 20px">
                ...
                <a style="color: #000" target="_blank"
                    href="https://api.whatsapp.com/send?phone=5522998321545&text=Ola%21+Gostaria+de+saber+mais+sobre+as+pe%C3%A7as%21">
        ...
        <div class="d text-center" style="padding: 0 10%;">
            <h3>
                Trabalhamos com moda masculina e feminina!
                Calças, Saias, Shorts e Bermudas Jeans. Camisas Polos, Malhas, Regatas e Sociais!
            </h3>
        </div>
        ...
        <produto-promocao-component :produtos="{{ json_encode($produtos) }}"></produto-promocao-component>
        <!-- -------------------------------------- -->
        ...
        <div class="d">
            ...
            <div class="divlavar">
                ...
                <div class="simboloslavar">
                    <img style="width: 100%" src="{{ asset('img/lavar.png') }}"
...
<script>
    ...
    document.onscroll = function() {
        ...
        btnInicio.style.display = "block": btnInicio.style.display = "none"
    }
</script>
